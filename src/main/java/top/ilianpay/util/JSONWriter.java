package top.ilianpay.util;

import top.ilianpay.ApiField;
import top.ilianpay.ApiListField;
...
public class JSONWriter {
    ...
    private void date(Date date) {
        if (this.format == null) {
            this.format = new SimpleDateFormat(IlianPay.DATE_TIME_FORMAT);
            this.format.setTimeZone(TimeZone.getTimeZone(IlianPay.DATE_TIMEZONE));
        }
        add("\"");
