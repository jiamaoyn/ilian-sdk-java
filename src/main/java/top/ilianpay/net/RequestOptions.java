...
public class RequestOptions {
    ...
    public static RequestOptions getDefault(String uri, String version) {
        return new RequestOptions(
                uri,
                version,
                IlianPay.DEFAULT_SIGN_TYPE,
                IlianPay.appId,
                IlianPay.apiKey,
                IlianPay.getConnectTimeout(),
                IlianPay.getReadTimeout(),
                IlianPay.getMaxNetworkRetries(),
                IlianPay.getAcceptLanguage());
    }
    ...
    public static class RequestOptionsBuilder {
        ...
        public RequestOptionsBuilder() {
            this.signType = IlianPay.DEFAULT_SIGN_TYPE;
            this.appId = IlianPay.appId;
            this.apiKey = IlianPay.apiKey;
            this.connectTimeout = IlianPay.getConnectTimeout();
            this.readTimeout = IlianPay.getReadTimeout();
            this.maxNetworkRetries = IlianPay.getMaxNetworkRetries();
            this.acceptLanguage = IlianPay.getAcceptLanguage();
        }
