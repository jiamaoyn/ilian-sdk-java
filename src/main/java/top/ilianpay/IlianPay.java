 ...
 * 数据对象
 */
public abstract class IlianPay {

    public static final String LIVE_API_BASE = "https://collectionapi.ilianpay.top";
    ...
    public static void setAcceptLanguage(String acceptLanguage) {
        IlianPay.acceptLanguage = acceptLanguage;
    }
}
