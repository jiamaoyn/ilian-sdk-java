...
import top.ilianpay.response.TransferOrderCreateResponse;
...
* 转账请求实现
*/
public class TransferOrderCreateRequest implements IlianPayRequest<TransferOrderCreateResponse> {
